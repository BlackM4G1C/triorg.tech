		...
		<div class="software-engineering">
			<div class="row">
				<div class="se-detail text-center">
					<div class="se-part-section">
						<div class="row">
							<div class="col-md-4 col-sm-4 ">
								<div class="se-part">
									<div class="se-img">
										<div class="carousel slide" data-ride="carousel" id="test-slide">
											<div class="carousel-inner">
												<div class="item active">
													<img src="img/se.jpg">
												</div>
							...
							<div class="col-md-4 col-sm-4">
								<div class="se-part">
									...
									<div class="se-letter">
										<h6>Desktop Application Programming</h6>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore </p>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="se-part">
									...
									<div class="se-letter">
										<h6>Android Application Programming</h6>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore </p>
									</div>
								</div>
							</div>
